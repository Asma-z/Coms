...
import { createMeeting, meetings } from "../_actions/meeting_actions";
import { committes } from "../_actions/committee_actions";
      ...
      >
        <Form name="create-meeting" form={MeetingForm}>
          ...
          <Form.Item name="college">
            <Select
              disabled={!MeetingForm.getFieldValue("university")}
              showSearch
          ...
          <Form.Item name="department">
            <Select
              ...
              optionFilterProp="children"
              onChange={(i) => {
                dispatch(committes({ department: i })).then((res) => {
